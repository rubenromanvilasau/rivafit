            ...
            <div className="flex h-full gap-4 mt-4">
                ...
                <div className="w-1/2 flex flex-col gap-8">
                    ...
                    <div className="flex justify-end">
                        <button className="bg-purple-800 text-white uppercase px-4 py-2 rounded-lg text-lg font-semibold hover:bg-transparent border-2 border-purple-800">Comprar</button>
                    </div>
                </div>
            </div>
        </div>
